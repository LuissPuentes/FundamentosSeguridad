...
## Solución
```bash
┌──(luispuentes㉿LuisPuentes)-[~/picoCTF/Parcial3/crypto_parte1/substitution0]
└─$ ls
message.txt
...
```
## Notas
En la pagina https://www.guballa.de/substitution-solver se ingreso el texto cifrado y regresa el texto decifrado, en el cual venia la bandera
