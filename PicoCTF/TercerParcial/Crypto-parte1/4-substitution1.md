...
## Solución
```bash
┌──(luispuentes㉿LuisPuentes)-[~/picoCTF/Parcial3/crypto_parte1/substitution1]
└─$ ls
message.txt
...
## Notas
En la pagina https://quipqiup.com/ se ingreso el texto cifrado y regresa el texto decifrado con diferentes keys, en uno de los cuales venia la bandera.
