...
## Solución
```bash
┌──(luispuentes㉿LuisPuentes)-[~/picoCTF/Parcial3/Reversing_parte2/keygenmepy]
...
## Notas
en el codigo nos muestra la linea correcta de codigo para obtener la parte dinamica de la bandera, la cual se escondia en el nombre ANDERSON.