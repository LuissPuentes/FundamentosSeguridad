...
┌──(luispuentes㉿LuisPuentes)-[~/picoCTF/reversing/vaultdoor4]
└─$ ls
VaultDoor4.java
...
## Notas
- la respuesta venia escondida en unos caracteres en octal, ascii hexadecimal y asi. En una funcion de java script decodificamos esos valores para obtener la bandera
